    ...
    public class GameInfo : INotifyPropertyChanged, IDisposable
    {
        ...
        public Avalonia.Media.Imaging.Bitmap ButtonImage
        {
            get
            {
                ...
                {
                    GameStatus.NotInstalled => "avares://WLauncher/Assets/Icons/button_download.png",
                    GameStatus.Installed => "avares://WLauncher/Assets/Icons/button_launch.png",
                    GameStatus.UpdateAvailable => "avares://WLauncher/Assets/Icons/button_update.png",
                    GameStatus.Downloading => "avares://WLauncher/Assets/Icons/button_loading.png",
                    GameStatus.Installing => "avares://WLauncher/Assets/Icons/button_loading.png",
                    _ => "avares://WLauncher/Assets/Icons/button_loading.png"
                };
        ...
        public IBrush ButtonColor
        {
            get
            {
                return Status switch
                {
                    GameStatus.NotInstalled => new SolidColorBrush(Color.FromRgb(99, 102, 241)),        // Indigo (#6366f1)
                    GameStatus.Installed => new SolidColorBrush(Color.FromRgb(16, 185, 129)),           // Emerald Green (#10b981)
                    GameStatus.UpdateAvailable => new SolidColorBrush(Color.FromRgb(245, 158, 11)),     // Amber (#f59e0b)
                    GameStatus.Downloading or GameStatus.Installing => new SolidColorBrush(Color.FromRgb(100, 116, 139)), // Slate Gray (#64748b)
        ...
        public static string? GetPlatformIcon(string assetName)
        {
                ...
                System.Text.RegularExpressions.Regex.IsMatch(assetNameLower, @"[_-]win[_-]|[_-]win\d|^win[_-]"))
            {
                ...
                {
                    return "avares://WLauncher/Assets/Icons/platform_win.png";
                }
            }
                ...
                (assetNameLower.Contains("mac") && !assetNameLower.Contains("machin")))
            {
                ...
                {
                    return "avares://WLauncher/Assets/Icons/platform_mac.png";
                }
            }
            ...
            if (HasAnyOf(assetNameLower, "linux", ".appimage", ".deb", ".rpm", "tar.gz", "tar.xz"))
            {
                ...
                {
                    return "avares://WLauncher/Assets/Icons/platform_lin.png";
                }
            }
